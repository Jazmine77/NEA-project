...
class Ui_mainMenu(object):
    ...
    def setupUi(self, mainMenu):
        ...
        self.World_blueW.setGeometry(QtCore.QRect(620, 540, 61, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.World_blueW.sizePolicy().hasHeightForWidth())
        self.World_blueW.setSizePolicy(sizePolicy)
        self.World_blueW.setStyleSheet("background-color: rgb(182, 220, 244);")
        self.World_blueW.setText("")
        self.World_blueW.setIcon(blue_whale)
        self.World_blueW.setIconSize(QtCore.QSize(60, 60))
        self.World_blueW.setObjectName("World_blueW_3")
        ...
        self.World_Hhead.setGeometry(QtCore.QRect(1130, 310, 61, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.World_Hhead.sizePolicy().hasHeightForWidth())
        self.World_Hhead.setSizePolicy(sizePolicy)
        self.World_Hhead.setStyleSheet("background-color: rgb(182, 220, 244);")
        self.World_Hhead.setText("")
        self.World_Hhead.setIcon(hammer_head)
        self.World_Hhead.setIconSize(QtCore.QSize(60, 60))
        self.World_Hhead.setObjectName("World_Hhead_3")
        ...
        self.World_SpermW.setGeometry(QtCore.QRect(1270, 360, 61, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.World_SpermW.sizePolicy().hasHeightForWidth())
        self.World_SpermW.setSizePolicy(sizePolicy)
        self.World_SpermW.setStyleSheet("background-color: rgb(182, 220, 244);")
        ...
        self.World_SpermW.setIcon(sperm_whale)
        self.World_SpermW.setIconSize(QtCore.QSize(60, 60))
        self.World_SpermW.setObjectName("World_SpermW_2")
        ...
        self.World_hump.setIcon(humpback)
        self.World_hump.setIconSize(QtCore.QSize(60, 60))
        self.World_hump.setObjectName("World_hump_2")
        ...
        self.World_greatW.setGeometry(QtCore.QRect(1120, 190, 61, 41))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.World_greatW.setIcon(great_white)
        self.World_greatW.setIconSize(QtCore.QSize(60, 60))
        self.World_greatW.setObjectName("World_greatW_3")
        ...
        self.NA_blueW_2 = QtWidgets.QLabel(self.centralwidget)
        self.NA_blueW_2.setGeometry(QtCore.QRect(1120, 460, 51, 31))
        self.NA_blueW_2.setStyleSheet("\n"
                                      "background-color: rgb(200, 235, 255);")
        self.NA_blueW_2.setText("")
        self.NA_blueW_2.setPixmap(QtGui.QPixmap("Bluewhale.png"))
        self.NA_blueW_2.setScaledContents(True)
        self.NA_blueW_2.setObjectName("NA_blueW_4")
        ...
        self.AF_greatwS = QtWidgets.QLabel(self.centralwidget)
        self.AF_greatwS.setGeometry(QtCore.QRect(700, 610, 71, 31))
        self.AF_greatwS.setStyleSheet("background-color: rgb(200, 235, 255);")
        self.AF_greatwS.setText("")
        self.AF_greatwS.setPixmap(QtGui.QPixmap("GreatWshark.png"))
        self.AF_greatwS.setScaledContents(True)
        self.AF_greatwS.setObjectName("AF_greatwS_3")
        ...
        self.predict.raise_()
        self.instructions.hide()  # hidden because it is not shown until prediction is selected
        ...
        self.SA_dot.raise_()
        self.SA_dot.hide()  # hidden because it is not shown until South America button is selected
        self.key.hide()  # hidden because it is not shown until prediction is selected
        self.key.raise_()
        self.key_cross.hide()  # hidden because it is not shown until prediction is selected
        self.key_cross.raise_()
        self.location_now.hide()  # hidden because it is not shown until prediction is selected
        ...
        self.Main_monkSeal.clicked.connect(self.Show_monkInfo)  # connect to subroutine which displays an info box
        self.Main_blueW.clicked.connect(self.show_blueInfo)
        self.World_blueW_2.clicked.connect(self.show_blueInfo)
        self.World_blueW.clicked.connect(self.show_blueInfo)
        ...
        self.World_greatW.clicked.connect(self.show_greatInfo)
        self.Main_Hhead.clicked.connect(self.show_hammerInfo)
        self.World_Hhead_2.clicked.connect(self.show_hammerInfo)
        self.World_Hhead.clicked.connect(self.show_hammerInfo)
        self.Main_hump.clicked.connect(self.show_humpInfo)
        self.World_hump.clicked.connect(self.show_humpInfo)
        self.Main_SpermW.clicked.connect(self.show_spermWInfo)
        self.World_SpermW.clicked.connect(self.show_spermWInfo)
        self.Prediction.clicked.connect(self.show_predictMenu)
        self.bw.clicked.connect(self.show_predictionBW)  # connects to subroutine that shows prediction for blue whales
        self.predict.clicked.connect(self.movement)  # connects to subroutine which displays drop down menu
    ...
    def hide_World(self):
        ...
        self.World_SpermW.hide()
        self.World_hump.hide()
        self.World_greatW.hide()
    ...
    def show_world(self):
        ...
        self.World_SpermW.show()
        self.World_hump.show()
        self.World_greatW.show()
